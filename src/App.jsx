      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6 font-sans">
        <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border">
          <div className="flex justify-center mb-4">
            {/* LOGO AQUI */}
            <img src="/taxxml_logo.jpg" alt="Tax XML Logo" className="w-48 object-contain" onError={(e) => { e.target.style.display='none' }} />
          </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6 font-sans">
        <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border">
           <div className="flex justify-center mb-4">
            {/* LOGO AQUI */}
            <img src="/taxxml_logo.jpg" alt="Tax XML Logo" className="w-32 object-contain" onError={(e) => { e.target.style.display='none' }}/>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <header className="flex justify-between items-center mb-10 bg-white p-6 rounded-2xl shadow-sm border">
            <h1 className="text-2xl font-black flex items-center gap-3 text-slate-800">
              {/* LOGO AQUI */}
              <img src="/taxxml_logo.jpg" alt="Tax XML Logo" className="w-10 h-10 object-contain" onError={(e) => { e.target.style.display='none' }}/> 
              Tax XML
            </h1>
