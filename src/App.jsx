...
import { FileText, Download, Loader2, LogOut, Wallet, CheckCircle, Clock, Settings, User, PlusCircle, ShieldCheck, QrCode, UserPlus, BarChart3, Users, DollarSign, Activity } from 'lucide-react'
...
function App() {
  ...
  // ==========================================
  // TELA DE LOGIN (COM ADMIN E REGISTRO)
  // ==========================================
  if (view === 'login') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f4f6f8] font-sans p-6">
        <div className="bg-white p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-md text-center border border-slate-100">
          ...
          {/* BOTÕES RESTAURADOS: CRIAR CONTA E ADMIN AQUI */}
