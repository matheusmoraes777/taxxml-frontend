      ...
      <div className="min-h-screen flex items-center justify-center bg-[#f4f6f8] font-sans p-6">
        <div className="bg-white p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-md text-center border border-slate-100">
          ...
          <div className="space-y-4 mb-6">
            <input type="email" placeholder="Seu E-mail" value={email} onChange={e=>setEmail(e.target.value)} className="w-full p-4 bg-[#f8fafc] border border-slate-200 rounded-xl outline-none focus:border-sky-500 transition-all text-slate-700" />
            <input type="password" placeholder="Sua Senha" value={senha} onChange={e=>setSenha(e.target.value)} className="w-full p-4 bg-[#f8fafc] border border-slate-200 rounded-xl outline-none focus:border-sky-500 transition-all text-slate-700" />
          </div>
          ...
          <div className="flex justify-between items-center mt-10 pt-6 border-t border-slate-100">
            <button onClick={() => setView('register')} className="text-sm font-bold text-sky-600 hover:text-sky-700 hover:underline transition-all">Criar uma Conta</button>
            <button onClick={acessarAdmin} className="text-slate-300 hover:text-slate-800 transition-all p-2 rounded-lg hover:bg-slate-50"><ShieldCheck size={22}/></button>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f4f6f8] font-sans p-6">
        <div className="bg-white p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-md text-center border border-slate-100">
          ...
          <div className="space-y-4 mb-6">
            <input type="text" placeholder="Seu Nome Completo" value={nome} onChange={e=>setNome(e.target.value)} className="w-full p-4 bg-[#f8fafc] border border-slate-200 rounded-xl outline-none focus:border-sky-500 text-slate-700" />
            <input type="email" placeholder="Seu E-mail" value={email} onChange={e=>setEmail(e.target.value)} className="w-full p-4 bg-[#f8fafc] border border-slate-200 rounded-xl outline-none focus:border-sky-500 text-slate-700" />
            <input type="password" placeholder="Crie uma Senha" value={senha} onChange={e=>setSenha(e.target.value)} className="w-full p-4 bg-[#f8fafc] border border-slate-200 rounded-xl outline-none focus:border-sky-500 text-slate-700" />
          </div>
          <button onClick={criarConta} disabled={loading} className="w-full py-4 bg-sky-600 hover:bg-sky-700 text-white font-bold rounded-xl mb-6 shadow-md flex justify-center items-center gap-2">
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
        <header className="bg-white border-b border-slate-200 px-4 md:px-8 py-4 flex flex-wrap justify-between items-center sticky top-0 z-50 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={handleLogout} className="text-red-500 hover:bg-red-50 p-2 rounded-lg transition-all"><LogOut size={18}/></button>
          </div>
        </header>
